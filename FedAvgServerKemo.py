...
if __name__=="__main__":
    ...
    history=fl.server.start_server(server_address="[::]:8084",strategy=fl.server.strategy.FedAvg(evaluate_fn = fl_save,inplace=False, min_fit_clients=5, min_available_clients=5, min_evaluate_clients=5), 
